...
##Plotting the Data
plot(Date_Time, final_data$Sub_metering_1, xlab="", ylab="Energy sub metering", type="l")
lines(Date_Time, final_data$Sub_metering_2, col="red")
lines(Date_Time, final_data$Sub_metering_3, col="blue")
legend("topright", legend=c("Sub_metering-1","Sub_metering-2","Sub_metering-3"), lty=c(1,1,1), col=c("black", "red", "blue"), cex=0.7)
